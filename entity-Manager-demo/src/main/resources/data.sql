...
insert into course(id, name, created_date, last_updated_date,is_deleted) 
values(10004,'Dummy Data1 Steps', sysdate(), sysdate(),false);
insert into course(id, name, created_date, last_updated_date,is_deleted) 
values(10005,'Dummy data2 Steps', sysdate(), sysdate(),false);
insert into course(id, name, created_date, last_updated_date,is_deleted) 
values(10006,'Dummy data3 Steps', sysdate(), sysdate(),false);
insert into course(id, name, created_date, last_updated_date,is_deleted) 
values(10007,'Dummy data4  Steps', sysdate(), sysdate(),false);
