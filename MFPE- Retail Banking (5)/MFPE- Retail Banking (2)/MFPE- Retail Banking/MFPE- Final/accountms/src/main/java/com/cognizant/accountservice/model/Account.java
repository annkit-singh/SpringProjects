...
public class Account {
	...
	public String toString() {
		return "Account [accountId=" + accountId + ", customerId=" + customerId + ", currentBalance=" + currentBalance
				+ ", accountType=" + accountType + ", openingDate=" + openingDate + ", ownerName=" + ownerName
				+ ", transactions=" + transactions + ", loan=" + loan + "]";
	}
